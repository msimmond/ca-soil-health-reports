...
# Base URL for static icon assets
# During development: point to Maegen's repo (use feature branch for testing)
# Before PR to UCANR: switch to UCANR-IGIS repo
ICON_BASE_URL <- "https://raw.githack.com/msimmond/ca-soil-health-reports/fix/image-paths-shiny-deployment/images"
